...
void Tracking::TransitionToNewState(std::map<std::string, eTrackingState> &mState, std::map<std::string, TrackingState*> &state, bool bOK, std::vector<KeyFrame*> newKFs) {
